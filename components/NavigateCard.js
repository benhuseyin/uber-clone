...
const NavigateCard = () => {
  ...
  return (
    <SafeAreaView style={tw`bg-white flex-1`}>
      <Text style={tw`text-center py-5 text-xl`}>Good Morning, Huseyin</Text>
      ...
      <View style={tw`flex-row bg-white justify-evenly py-2 mt-auto border-t border-gray-100`}>
            ...
            <TouchableOpacity style={'flex flex-row justify-between bg-black w-24 px-4 py-3 rounded-full'}>
                <Icon 
